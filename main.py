...
if __name__ == '__main__':
    ...
    for r in r_classes_dev.keys():
        f1 = ((r + best_gamma*r_classes_dev[r]) / (training_set_size + vocabulary_size  * best_gamma))*training_set_size
        f2 = heldout_model.held_out_probability[r]*small_training_set_size
        NTr = heldout_model.r_classes[r]
        tr = 0
        for event in r_classes_dev[r]:
          tr += heldout_model.Counter[event]
